<template>
  ...
  >
    ...
    <button
      @click="toggleLocale"
      class="fixed top-4 right-18 sm:top-6 sm:right-20 z-50 p-3 bg-white/10 backdrop-blur-md rounded-full hover:bg-white/20 transition-all duration-200 border border-white/10 shadow-lg hover:shadow-xl cursor-pointer group"
